// Implement a stack using two queues by Method-II (making Dequeue operation costly in terms of time)
...
int top(struct Stack* stack) {
    ...
    int topVal = dequeue(stack->q1);
    enqueue(stack->q2, topVal); // put it back
